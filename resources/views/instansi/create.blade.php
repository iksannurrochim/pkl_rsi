...
<div class="page-heading">
    <div class="page-title">
      <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
          <h3>Form Tambah Instansi</h3>
          <p class="text-subtitle text-muted">
            Lengkapi Data Untuk Menambah Instansi.
          </p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
          ...
          >
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.html">Tambah Instansi</a></li>
            </ol>
          </nav>
        </div>
      </div>
    ...
    <form id="form-instansi" action='{{url('instansi')}}' method='post'>
    @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group mandatory">
                              ...
                              <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Alamat" type="text" value="{{ Session::get('alamat') }}" required></textarea>
        ...
        $('#form-instansi').submit(function (event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    Swal.fire({
                        title: 'Berhasil Menambahkan Instansi',
